...
# Creating and saving the graph as plot2.png
## need to rename Global_active_power to Global Active Power (kilowatts) fro axis labeling
par(mfrow = c(1,1))
with(read3,plot(Date_Time,Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)"))
