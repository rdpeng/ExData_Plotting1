# plot2.R Programming assignment for week 1 of coursera's Exploratory Data Analysis Course
#
...
# create plots
with(hpc,plot(datetime, Global_active_power, type='l',col='black',ylab = 'Global Active Power (kilowatts)',xlab =''))
