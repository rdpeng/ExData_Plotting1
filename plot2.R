...
png(file="Assignment 1/plot2.png", width=480, height=480)
plot(dt$Global_active_power, col="red", breaks=12, xlab="Global Active Power (kilowatts)", main="Global Active Power")
dev.off()
