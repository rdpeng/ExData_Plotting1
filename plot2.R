...
#Create plot2, a line plot of Global_active_power vs. DayOfWeek
png(filename="plot2.png", width=480, height=480)
plot(x=power2$DateTime, y=power2$Global_active_power, type="l", xaxt="n", xlab="", ylab="Global Active Power (kilowatts)")
