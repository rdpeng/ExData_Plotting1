...
DSub$NewDT <- decDT(paste(DSub$ADate,DSub$Time)) # Best I can do: I do not know how to get Friday etc,
plot(DSub$NewDT,DSub$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")  # lines
