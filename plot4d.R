# Program code for Exploratory Data Analysis Project 1 Plot 4 Lower Right Graph
...
# Defines X axis Label
        myXAxisLabel <- "datatime"

# Defines Y axis Label
        myYAxisLabel <- "Global_reactive_power"
...
# Makes Plot
    ...
    # Global_reactive_power       
        plot((myDataSubSet$datetime),(as.numeric(as.character(myDataSubSet$Global_reactive_power))),
