# Program code for Exploratory Data Analysis Project 1 Plot 4 Upper Right Graph
...
# Makes Plot
    ...
    # Voltage        
        plot((myDataSubSet$datetime),(as.numeric(as.character(myDataSubSet$Voltage))),
