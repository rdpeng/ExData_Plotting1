...
plot(hpc$datetime, hpc$Global_active_power, type ="l", xlab="", ylab="Global Active Power (kilowatts)")  ##create a line plot of the Global Active Power across the 2 days
dev.copy(png, file= "Plot2.png")  ##copy the line plot to a png file
