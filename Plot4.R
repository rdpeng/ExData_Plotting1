...
plot(as.numeric(power$Voltage)/10,type="l",ylab="Voltage",xaxt="n",xlab="datetime")
axis(2,at=c("234","238","242","246"),labels=c("234","238","242","246"))
axis(1,at=c("0","1500","2900"),labels=c("Thu","Fri","Sat"))

plot(as.numeric(power$Global_reactive_power)/500,type="l",xlab="datetime",ylab="Global Active Power (kilowatts)",xaxt="n")
axis(1,at=c("0","1500","2900"),labels=c("Thu","Fri","Sat"))
