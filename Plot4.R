...
par(mfrow=c(2,2))
plot(period$convert_time, period$Global_active_power, type="l", col="green", xlab="", ylab="Global Active Power")
plot(period$convert_time, period$Voltage, type="l", col="orange", xlab="datetime", ylab="Voltage")
...
plot(period$convert_time, period$Global_reactive_power, type="l", col="blue", xlab="datetime", ylab="Global_reactive_power")
