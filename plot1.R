...
png(filename = "plot1.png", width = 480, height = 480, units = "px", pointsize=6, res = 140)
hist(epc_sel$Global_active_power, col="red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
dev.off()
