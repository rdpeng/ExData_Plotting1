...
#PLOT 1: histogram of the Global Active Power showing changes over the period of interest
hist(power.data.ss$Global_active_power,main="Global Active Power",xlab="Global Active Power (kilowatts)",ylim=c(0,1300),col="red")

#verify the plot is the correct on the screen before proceeding to save in the required format
