...
par(mfrow=c(2,2))
plot(subfile$DateTime,subfile$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(subfile$DateTime,subfile$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,col=c("black","red","blue"),text.width=strwidth("Sub_metering_1"),bty="n")
plot(subfile$DateTime,subfile$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()
