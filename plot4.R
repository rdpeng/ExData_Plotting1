...
legend('topright', c("Sub_metering_1","Sub_metering_2","Sub_metering_3") , lty=0.5, col=c("black","red","blue"),cex=0.3, xjust=1, yjust=1,x.intersp=0.2, y.intersp=0.1,inset = 0)
