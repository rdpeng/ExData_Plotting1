...
plot(both_days_data$Voltage,type="l",ylab="Voltage",xlab="datetime",xaxt="n")
axis(side=1,labels=c("Thu","Fri","Sat"),at=c(1,(dim(both_days_data)[1])/2,dim(both_days_data)[1]))
...
axis(side=1,labels=c("Thu","Fri","Sat"),at=c(1,(dim(both_days_data)[1])/2,dim(both_days_data)[1]))
legend("topright",c(names(both_days_data[7:9])),col=c("black","red","blue"),lty=1,bty="n")

plot(both_days_data$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime",xaxt="n")
axis(side=1,labels=c("Thu","Fri","Sat"),at=c(1,(dim(both_days_data)[1])/2,dim(both_days_data)[1]))
