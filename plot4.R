...
# Plot the data
    ...
    #Then have to get factor variables into numeric form
        ...
        mydata_subset2$Global_reactive_power <- as.numeric(as.character(mydata_subset2$Global_reactive_power))
        mydata_subset2$Voltage <- as.numeric(as.character(mydata_subset2$Voltage))
    ...
    #Then plot
        ...
        #Plot 4a (=Plot2)
            plot(mydata_subset2$Date, mydata_subset2$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

        #Plot 4b (new)
            plot(mydata_subset2$Date, mydata_subset2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
        ...
        #Plot 4d (new)
            plot(mydata_subset2$Date, mydata_subset2$Global_reactive_power, type = "l", xlab = "", ylab = "Global_reactive_power")
            #^had to change class to numeric from factor to get y-axis units to match example
