...
plot(hhpwcons$datetime,hhpwcons$Voltage,  type = "l", xlab = "datetime", ylab="Voltage")
plot(hhpwcons$datetime,hhpwcons$Global_reactive_power,  type = "l", xlab = "datetime", ylab="Global_reactive_power")
dev.off()
