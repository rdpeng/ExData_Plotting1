...
#splitting plot in four sub plots

par(mfrow=c(2,2))

plot(dates,sub_data[,3],ylab="Global Actice Power",xlab="",type="l")

plot(dates,sub_data$Voltage,ylab="Voltage",xlab="",type="l")
...
plot(dates,sub_data[,4],ylab="Global_reactive_power",xlab="datetime",type="l")

#turing png device off
dev.off() 
