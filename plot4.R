...
## multiple graphics on 1 screen/png/pdf/etc.
par(mfcol = c(2,2))

##first plot is from 2nd task
...
with(tidyData,plot(Voltage ~ Time, type="l", xlab ="datetime"))

##fourth 
with(tidyData,plot(Global_reactive_power ~ Time, type="l", xlab ="datetime"))
