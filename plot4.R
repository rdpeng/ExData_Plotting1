...
par(mfcol = c(2,2))
plot(png_txt$TimeStamp,png_txt$Global_active_power, ylab = "Global Active Power", xlab = "",type="l")
...
plot(png_txt$TimeStamp, png_txt$Voltage,ylab = "Voltage", xlab = "datetime",type="l")
plot(png_txt$TimeStamp, png_txt$Global_reactive_power,ylab = "Global_reactive_power", xlab = "datetime",type="l")
dev.off()
