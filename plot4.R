data <- read.table("C:/Users/Thanh/Downloads/exdata-data-household_power_consumption/household_power_consumption.txt", header = TRUE, sep = ";", dec = ".",na.strings = "?",skip = 66637,nrows = 2880)
df<-data.frame(data)
...
png("C:/Users/Thanh/Documents/GitHub/Huong/plot4.png",bg="transparent",width=480,height=480)
