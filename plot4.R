...
#Create Plot 4 and convert to PNG#
png("plot4.png", width = 480, height = 480)
par(mfrow = c(2,2))
with(data, {
  with(data, plot(Date, Global_active_power, type="o", pch = ".", xlab = "", ylab = "Global Active Power (kilowatts)"))
  with(data, plot(Date, Voltage, type = "o", pch = ".", xlab = "datetime"))
  ...
  with(data, plot(Date, Global_reactive_power, type = "o", pch = ".", xlab = "datetime"))
})
dev.off()
