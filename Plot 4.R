...
### Create plot Q4
  ...
  legend("topright",pch=1,col=c("Black","Red","Blue"),legend =c("Sub_Metering_1","Sub_Metering_2","Sub_Metering_3"),cex=0.5)
  plot(DF$DateTime, DF$Global_reactive_power, xlab = "", ylab = "Global Reactive Power(Kilowatts)", type = "l")
  })
