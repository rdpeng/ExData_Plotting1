...
dput (hpc2, file = "hpc2.R")
# to import the data.frame, use 'hpc2 <- dget ("./hpc2.R")'
# print the plot n. 1 as PNG file
png (filename = "plot1.png", width = 480, height = 480, units ="px", type = "windows")
# create the plot n. 1
hist (hpc2$Global_active_power, xlab = "Global Active Power (kilowatts)", ylim = c(0, 1200), main = "Global Active Power", col = "Red")
