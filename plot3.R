...
interestedDatesData$DateTime <-strptime(paste(interestedDatesData$Date,
                                        ...
                                        format="%Y-%m-%d %H:%M:%S")
with(interestedDatesData,plot(interestedDatesData$DateTime,
                              interestedDatesData$Sub_metering_1,type ="l",
                              xlab = "",ylab = "Energy sub metering"))
with(interestedDatesData,points(interestedDatesData$DateTime,
                                interestedDatesData$Sub_metering_2,type ="l",
                                col = "red"))
with(interestedDatesData,points(interestedDatesData$DateTime,
                                interestedDatesData$Sub_metering_3,type ="l",
                                col = "blue")) 
