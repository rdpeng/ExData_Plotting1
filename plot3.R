...
plot(data_cut$Sub_metering_1~data_cut$datetime, type = "l", ylab = "Energy sub metering", xlab = "")
lines(data_cut$Sub_metering_2~data_cut$datetime, type = "l", col = "red")
lines(data_cut$Sub_metering_3~data_cut$datetime, type = "l", col = "blue")
