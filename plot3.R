...
plot(data$Time2,data$Sub_metering_1,t="l", ylab= "Energy sub Matering",xlab="")
lines(data$Time2,data$Sub_metering_2,t="l", col="red")
lines(data$Time2,data$Sub_metering_3,t="l", col="blue")
