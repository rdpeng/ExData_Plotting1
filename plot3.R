...
#creating a plot
plot(x = data_selected$DT, y =data_selected$Sub_metering_1, ylab = "Energy sub metering", ylim=c(0, 38), xlab = "", type = "l", col = "black")
...
#add a legend
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c(1,2,4), lty=(1),text.width = strwidth("1000000000000,000,000")) 
